<?php 
SESSION_start();
if($_SESSION['vip']!='admin') die('<h1 style="text-align:center">ERRO! 404 Page</h1>');
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
	...
	<ul class="nav-side">
		...
		<li><a href="javascript:iframe('banner');"><i class="layui-icon">&#xe656;</i><span>Banner管理</span></a></li>
		<li><a href="javascript:iframe('content');"><i class="layui-icon">&#xe653;</i><span>帖子管理</span></a></li>
		<li><a href="javascript:iframe('user');"><i class="layui-icon">&#xe770;</i><span>用户管理</span></a></li>
		<li><a href="javascript:iframe('reply');"><i class="layui-icon">&#xe63a;</i><span>回复管理</span></a></li>
		<li><a href="javascript:iframe('cate');"><i class="layui-icon">&#xe857;</i><span>分类管理</span></a></li>
		<hr class="layui-bg-green">
		<li><a href="javascript:iframe('setting');"><i class="layui-icon">&#xe614;</i><span>设置</span></a></li>
